export const HorseRace = {
    ...
    initializeHorses() {
        ...
        horsePercentages.forEach(
            (percentage) => (percentage.textContent = "0%"),
        );
        this.setHorsesState("rest");
    },
    ...
    applyWinner(winnerId) {
        ...
        lanes.forEach((lane) => {
            const isWinner =
                lane.dataset.laneIndex === String(parsedWinnerId - 1);
    ...
    showCountdown() {
        ...
        const container =
            document.getElementById("horses-container") || this.el;
        if (container) {
        ...
        this.countdownInterval = setInterval(() => {
            ...
            if (count > 0) {
                ...
                setTimeout(() => {
                    if (
                        document.getElementById("race-countdown") === countdown
                    ) {
                        countdown.remove();
                    }
                }, 500);
