defmodule Pearl.Contest.BadgeTrigger do
  ...
  @events ~w(upload_cv_event play_slots_event play_coin_flip_event play_wheel_event redeem_spotlighted_badge_event link_credential_event play_horse_race_event play_scratch_card_event)a
