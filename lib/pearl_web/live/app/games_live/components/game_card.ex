defmodule PearlWeb.App.GamesLive.Components.GameCard do
  ...
  def game_card(assigns) do
    ...
    <.link
      ...
      class="flex flex-col h-full group gap-6 border-white border-2 bg-black/20 p-8 backdrop-blur-md transition-all duration-500 hover:border-white/20 hover:bg-primary/80 hover:shadow-2xl hover:shadow-primary/10"
    >
