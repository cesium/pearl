defmodule PearlWeb.Backoffice.MinigamesLive.SlotsPaytable.FormComponent do
  @moduledoc false
              ...
              <li class="border-b-[1px] last:border-b-0 border-lightShade dark:border-darkShade">
                ...
                >
                  ...
                  <div class="grid space-x-2 grid-cols-9 pl-1">
                    <.field field={form[:multiplier]} id={"multiplier-#{id}"} type="number" wrapper_class="col-span-2" />
                    <.field field={form[:probability]} id={"probability-#{id}"} type="number" wrapper_class="col-span-2" />
                    <.link
