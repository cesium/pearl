        ...
        <div class="w-full mx-auto px-6.5 md:px-16 mb-20">
          <div class="relative z-10">
            <div class="flex justify-between items-end">
              ...
              <div class="w-[46%] hidden lg:block lg:-mb-30 xl:-mb-10 z-5 bg-light p-5 lg:p-6 lg:pr-16">
            ...
            <div>
              ...
              <div class="relative isolate overflow-visible">
                <div class="flex flex-col gap-10 items-center w-full h-full">
                  <div class="-mt-10 w-[84%] lg:hidden bg-light p-5 lg:p-6 lg:pr-16">
                    <div class="text-dark leading-relaxed space-y-4">
                      <p>
                        {gettext("O Encontro Nacional de Estudantes de Informática é um evento anual
                                  repleto de palestras, workshops, tertúlias, e muitas mais atividades.
                  ...
                  <div class="flex flex-col md:mt-10 lg:flex-row items-center justify-center gap-3 text-dark/50 text-center">
